# Build nabla.xlsx from the earlier Financial Starter Pack workbook.
...
# fix earlier copy-paste bug: the u module's About suggested "nabla.e" (was BXE) as its own name
...
if "nabla.f.SumDepreciateλ" not in names:  # earlier omitted it from the index
...
# The printerSettings parts embed a printer name and US Letter paper.
for i in (1, 2, 3):
...
core = core.replace("<cp:lastModifiedBy>",
                    ...
                    "<dc:creator>nabla project</dc:creator><cp:lastModifiedBy>")
