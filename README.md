...
v3.4.2 `ozzit.xlsx` SHA-256: `0306793a7e473ce70e78149fea1e107fc0f714d61ab50960c16f6fd528878f6f` (439,097 bytes), the same bytes as the release asset. `main` is ahead of that tag, so the file you clone is not the file the release ships: the tracked `ozzit.xlsx` is SHA-256 `98209718f7293234e3b4f08266e17e253346c74e5e7c1beac742a6eda7be5c07` (440,671 bytes), pinned in [release/workbook-base.json](release/workbook-base.json) and checked by the tool tests. On the tracked file, Excel 16.0 build 20430 on 21 September 2026: 1,129 formulas recalculated with 0 in error, 912 self-test assertions with 0 failures, 19,446 cached values equal to what their formulas produce, and the workbook byte-identical before and after both native gates.
