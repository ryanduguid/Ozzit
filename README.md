...
[LICENCE](LICENCE) is MIT and covers only what was written for this repository: `tools/`, `.github/`, the Markdown files and `assets/`. It does not cover `nabla.xlsx`, `src/` or `functions.csv`, which were carved out at the time.
