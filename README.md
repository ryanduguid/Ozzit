...
| `tools/` | The build and maintenance pipeline: rebuilds the v3.0.0 workbook baseline from the earlier workbook (the current release is later; see CHANGELOG), synchronises the AFE store, canonicalises/polishes it, and checks it |
