...
v3.4.1 `ozzit.xlsx` SHA-256: `71db4f7650b8f40a27c06524bb031166dfe96b9f25c4b8e8ba2928679d2391e7` (438,897 bytes), the same file as the tracked `ozzit.xlsx` on `main`, whose digest is pinned in [release/workbook-base.json](release/workbook-base.json) and checked by the tool tests. Excel 16.0 build 20430 on 13 September 2026: 1,129 formulas recalculated with 0 in error, 868 self-test assertions with 0 failures, 19,444 cached values equal to what their formulas produce.
