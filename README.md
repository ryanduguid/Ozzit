...
| `tools/` | The build pipeline: rebuilds the workbook from the earlier workbook and checks it |
...
Nabla is Ryan Duguid's own LAMBDA library, rebuilt from his earlier workbook. See [ATTRIBUTION.md](ATTRIBUTION.md) for provenance and the full list of changes.
