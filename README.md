...
Tracked `ozzit.xlsx` on `main` (v3.4.1 plus the unreleased corrections in [CHANGELOG.md](CHANGELOG.md)) SHA-256: `08e51baa16969c92ed3e7b0fc585a689afafc02cb0ac84e411c6eadde2cf453e` (442,719 bytes), whose digest is pinned in [release/workbook-base.json](release/workbook-base.json) and checked by the tool tests. Excel 16.0 build 20430 on 14 September 2026: 1,129 formulas recalculated with 0 in error, 905 self-test assertions with 0 failures, 19,444 cached values equal to what their formulas produce.
