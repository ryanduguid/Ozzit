...
Tracked `ozzit.xlsx` on `main` (v3.4.1 plus the unreleased corrections in [CHANGELOG.md](CHANGELOG.md)) SHA-256: `bd8bcf7090054d8a92df5b5b113723573cde01c148c1ca445977328b90ee08eb` (441,380 bytes), whose digest is pinned in [release/workbook-base.json](release/workbook-base.json) and checked by the tool tests. Excel 16.0 build 20430 on 13 September 2026: 1,129 formulas recalculated with 0 in error, 897 self-test assertions with 0 failures, 19,444 cached values equal to what their formulas produce.
