...
The library is Australian-only. Tax content follows ATO practice, and the foreign tax regimes and references the predecessor library carried have been removed rather than relabelled.
...
| `tools/` | The build pipeline: rebuilds the workbook from the predecessor workbook and verifies it |
