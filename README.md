...
Ozzit is a renamed and reworked derivative of the workbook author Ryan Duguid's predecessor workbook (predecessor). See [ATTRIBUTION.md](ATTRIBUTION.md) for provenance, predecessor copyright and the full list of changes. This repository adds Australian GST, financial-year and modelling-depreciation helpers; it is not an individual-tax or Division 7A engine.
