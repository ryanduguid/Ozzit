...
The library is Australian-only. Tax content follows ATO practice, and the foreign tax regimes and references the earlier library carried have been removed rather than relabelled.
...
| `tools/` | The build pipeline: rebuilds the workbook from the earlier workbook and verifies it |
