...
- `tools/transform_from_earlier.py` now names the earlier functions `ozzit.*` on the way
...
### Fixes
- Defined `nabla.e.Aboutλ`; the earlier workbook called `the earlier namespace Aboutλ` on its own worksheet without defining it.
